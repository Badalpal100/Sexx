...
bot = telebot.TeleBot('PUT YOUT BOT TOKEN')
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 180:
                ...
                record_command_logs(user_id, '/m4', target, port, time) #cmd change kr lena 😁 [ line : 251 and 256
